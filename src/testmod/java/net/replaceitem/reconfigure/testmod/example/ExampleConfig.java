...
public class ExampleConfig {
    ...
    public final Property<Integer> INT = SIMPLE_TAB.createIntegerProperty("size").range(1,10).asSlider().displayName(Text.literal("integer 1-10")).build();
    public final Property<Integer> INT_STEP = SIMPLE_TAB.createIntegerProperty("size").range(1, 12).asSlider().displayName(Text.literal("integer 1-12 step 3")).step(3).build();
    public final Property<Double> DOUBLE = SIMPLE_TAB.createDoubleProperty("size").range(-0.5, 15.0).asSlider().displayName(Text.literal("dbl -.5-15")).build();
    public final Property<Double> DOUBle_STEP = SIMPLE_TAB.createDoubleProperty("size").range(-0.5, 15.2).asSlider().displayName(Text.literal("dbl -.5-15.2 step 0.25")).step(0.25).build();
    public final Property<Double> BIG_DOUBLE = SIMPLE_TAB.createDoubleProperty("size").range(0.0, 15000.0).asSlider().displayName(Text.literal("big dbl 0-15000")).build();
    public final Property<Double> SMALL_DOUBLE = SIMPLE_TAB.createDoubleProperty("size").range(0.0, 0.001).asSlider().displayName(Text.literal("small dbl 0-0.001")).build();
