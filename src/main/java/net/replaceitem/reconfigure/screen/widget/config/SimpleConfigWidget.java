...
public abstract class SimpleConfigWidget<W extends ClickableWidget, P> extends PropertyConfigWidget<P> {
    ...
    public SimpleConfigWidget(ConfigWidgetList listWidget, int height, Property<P> property, BaseSettings baseSettings) {
        super(listWidget, height, property, baseSettings);
    }

    public SimpleConfigWidget(ConfigWidgetList listWidget, Property<P> property, BaseSettings baseSettings) {
