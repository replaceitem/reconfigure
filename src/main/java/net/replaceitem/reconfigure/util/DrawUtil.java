...
public class DrawUtil {
    public static void renderRectOutline(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, int color) {
    ...
    public static void drawCheckerboard(GuiGraphicsExtractor context, int x1, int y1, int x2, int y2, int size, int color) {
        int w = x2-x1;
        int h = y2-y1;
